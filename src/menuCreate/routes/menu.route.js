...
import { authenticateToken, requireSuperAdminOrAdminRole } from "../../helper/middlewares/auth.middleware.js";
import {
  upload,
  errorCheck,
...
router.patch("/admin/status/:id", authenticateToken, requireSuperAdminOrAdminRole, updateProfileStatus);
